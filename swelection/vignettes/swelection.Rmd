...
There is also a shiny app that has links to this package. The Shiny app can be used to visualize the result of the municipal elections in Linköping for different regions in Linköping.
